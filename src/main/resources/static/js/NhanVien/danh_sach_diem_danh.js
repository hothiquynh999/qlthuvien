$(document).ready(function () {
    ...
    $("#ngayDiemDanh").change(function () {
        var ngayDiemDanh = $("#ngayDiemDanh").val();
        window.location.href = '?ngay=' + ngayDiemDanh;
    });
    ...
    $("#click_luu").click(function () {
        ...
        $.ajax({
            ...
            'type': 'POST',
            'url': url + "nhan-vien/api/diem-danh-update/" + diemDanh,
            'dataType': 'json',
            success: function (data) {
                alert('Sửa thành công');
                window.location.href = 'danh-sach-diem-danh';
            },
            error: function () {
                console.log("error");
            }
